<template>
  <div class="short">
    ...
    <div v-for="(num, i) in sex" :key="i" class="sublet"> 
      <van-panel :title="num.title" desc="描述信息" :status="num.status" use-footer-slot class="sublet_main">
        ...
        <div slot="footer">
          <van-button size="small" icon="star-o" color="#FFCC66" plain>收藏</van-button>
        </div>
      </van-panel>
    </div>
  </div>
